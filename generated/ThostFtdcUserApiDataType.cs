...
public enum TThostFtdcTimeRangeType: byte
{
    ...
    /// 一般月份
    /// </summary>
    THOST_FTDC_ETR_USUAL = (byte)'1',
    /// <summary>
    /// 交割月前一个月上半月
    /// </summary>
    THOST_FTDC_ETR_FNSP = (byte)'2',
    /// <summary>
    /// 交割月前一个月下半月
    /// </summary>
    THOST_FTDC_ETR_BNSP = (byte)'3',
    /// <summary>
    /// 交割月份
    /// </summary>
    THOST_FTDC_ETR_SPOT = (byte)'4',
}
/// <summary>
/// 新型组保算法类型
/// </summary>
...
public enum TThostFtdcWithDrawParamIDType: byte
{
    ...
    /// </summary>
    THOST_FTDC_WDPID_CashIn = (byte)'C',
}
/// <summary>
/// 投资者交易权限类型
/// </summary>
public enum TThostFtdcInvstTradingRightType: byte
{
    ...
    /// 只能平仓
    /// </summary>
    THOST_FTDC_ITR_CloseOnly = (byte)'1',
    /// <summary>
    /// 不能交易
    /// </summary>
